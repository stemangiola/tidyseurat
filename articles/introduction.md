...
```
    ...
    ##  [1] future_1.69.0      tidyseurat_0.8.9   ttservice_0.5.3    Seurat_5.4.0      
    ##  [5] SeuratObject_5.3.0 sp_2.2-1           ggplot2_4.0.2      magrittr_2.0.4    
    ##  [9] purrr_1.2.1        tidyr_1.3.2        dplyr_1.2.0        knitr_1.51        
    ## 
    ...
    ##  [22] ragg_1.5.0             xfun_0.56              cachem_1.1.0          
    ##  [25] jsonlite_2.0.0         goftest_1.2-3          later_1.4.7           
    ##  [28] spatstat.utils_3.2-1   irlba_2.3.7            parallel_4.6.0        
    ##  [31] cluster_2.1.8.2        R6_2.6.1               ica_1.0-3             
    ##  [34] spatstat.data_3.1-9    bslib_0.10.0           stringi_1.8.7         
    ##  [37] RColorBrewer_1.1-3     GGally_2.4.0           reticulate_1.45.0     
    ...
    ## [100] fansi_1.0.7            spam_2.11-3            viridisLite_0.4.3     
    ## [103] uwot_0.2.4             gtable_0.3.6           sass_0.4.10           
    ## [106] digest_0.6.39          progressr_0.18.0       ggrepel_0.9.7         
